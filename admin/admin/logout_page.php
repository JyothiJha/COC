...
<body class="account-pages">
    <a href="../home.html">
        <button class="btn" style="position: fixed;
            ...
            cursor: pointer;
            padding: 4px;
            border-radius: 4px;"><i class="fa fa-home"></i>
        </button>
    </a>
    <div class="accountbg" style="background: url('image/logout.jpg');background-size: cover;background-position: center; width: 60%;"></div>
        <div class="wrapper-page account-page-full">
            ...
            <div class="m-t-40 text-center">
                <p class="account-copyright">COUNT ON CALORIES</p>
            </div>
        </div>
